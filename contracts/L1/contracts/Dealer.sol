...
//     function setWithdrawRewards(bool _withdrawRewards) external onlyTimeLockOrAdmin {
...
//     function addAgent() external onlyTimeLockOrAdmin returns (uint32) {
...
//     function lockFor(uint32 agentId, address sequencerSigner, uint256 amount, bytes memory signerPubKey) external onlyTimeLockOrAdmin {
...
//     /// @param agentId The index of the sequencer agent.
//     function unlock(uint32 agentId) external payable onlyTimeLockOrAdmin {
...
//     /// @param agentId The index of the sequencer agent.
//     function unlockClaim(uint32 agentId) external payable onlyTimeLockOrAdmin {
...
//     function setActive(uint32 agentId, bool active) external onlyTimeLockOrAdmin {
...
//     function setSequencerAgentTemplate(address _sequencerAgentTemplate) external onlyTimeLockOrAdmin {
...
//     function setL2Gas(uint32 _l2Gas) external onlyTimeLockOrAdmin {
//         uint32 _old = l2Gas;
//         l2Gas = _l2Gas;
