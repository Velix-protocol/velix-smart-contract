...
contract SequencerAgent is ContextUpgradeable {
    ...
    function initialize(address _dealer, address _lockingPool, address _metis) external initializer {
        dealer = _dealer;
    ...
    function lockFor(address _sequencerSigner, uint256 _amount, bytes memory _signerPubKey) public onlyDealer {
